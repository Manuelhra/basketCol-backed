...
export class ExpressLeagueFounderUserServerErrorHandler implements IServerErrorHandler {
  ...
  public static create(dependencies: Dependencies): ExpressLeagueFounderUserServerErrorHandler {
    return new ExpressLeagueFounderUserServerErrorHandler(dependencies);
  }

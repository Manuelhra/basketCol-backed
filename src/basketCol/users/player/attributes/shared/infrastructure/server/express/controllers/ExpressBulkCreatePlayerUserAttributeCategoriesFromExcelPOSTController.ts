...
type Dependencies = {
  ...
  readonly bulkCreatePlayerUserAttributeCategoriesFromExcelService: BulkCreatePlayerUserAttributeCategoriesFromExcelService;
};
...
implements ExpressBaseController {
  ...
  public async run(request: Request, response: Response): Promise<void> {
    ...
    await this.dependencies.bulkCreatePlayerUserAttributeCategoriesFromExcelService.execute(workBook, request.userContext);

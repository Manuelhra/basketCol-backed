...
import {
  HttpStatus,
  InvalidTeamPlayerStatusError,
  TeamPlayerAlreadyRegisteredError,
...
export class ExpressTeamPlayerServerErrorHandler implements IServerErrorHandler {
  private constructor(private readonly dependencies: Dependencies) {}

  public static create(dependencies: Dependencies): ExpressTeamPlayerServerErrorHandler {
    return new ExpressTeamPlayerServerErrorHandler(dependencies);
  }
  ...
  public run(response: Response, error: Error): void {
    ...
    switch (true) {
      case error instanceof InvalidTeamPlayerStatusError:
      case error instanceof TeamPlayerAlreadyRegisteredError:

...
type Dependencies = {
  ...
  readonly bulkCreateLeagueSeasonFixtureGameFromExcelService: BulkCreateLeagueSeasonFixtureGameFromExcelService;
};

export class ExpressBulkCreateLeagueSeasonFixtureGameFromExcelPOSTController
implements ExpressBaseController {
  ...
  public static create(dependencies: Dependencies): ExpressBulkCreateLeagueSeasonFixtureGameFromExcelPOSTController {
    return new ExpressBulkCreateLeagueSeasonFixtureGameFromExcelPOSTController(dependencies);
  }
  ...
  public async run(request: Request, response: Response): Promise<void> {
    ...
    await this.dependencies.bulkCreateLeagueSeasonFixtureGameFromExcelService.execute(workBook, request.userContext);
    response.status(HttpStatus.CREATED).send();
  }

  public getExcelFileUploadMiddleware(): RequestHandler {
    return this.#excelFileUploadMiddleware.single('fixture-games');
  }
}
